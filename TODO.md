...
- 生产 Kotlin 190 个文件，约 2.83 万有效代码行；JVM 测试 71 个文件、285 个用例。
- Compose 截图测试 6 个文件、34 张参考图，覆盖应用壳层、五个一级页面、页面顶部栏、认证与账号安全反馈、设置行、APRS、BLE 配网、存储页、工具子页、弹窗、Bottom Sheet 和首批页面反馈状态。
