...
- 生产 Kotlin 191 个文件，约 2.85 万有效代码行；JVM 测试 72 个文件、288 个用例。
- Compose 截图测试 6 个文件、38 张参考图，覆盖启动与应用壳层、五个一级页面、页面顶部栏、趋势空态、更新反馈、认证与账号安全反馈、设置行、APRS、BLE 配网、存储页、工具子页、弹窗、Bottom Sheet 和首批页面反馈状态。
