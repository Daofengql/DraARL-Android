...
生产源码基线 `6ef4c48` 的静态回归构建同样通过 `assembleRelease`：APK 为 32,062,557 B（30.58 MiB），SHA-256 为
`EB867FE269FF79E7F1C0173723AFEE2996FC02BEE03AD48AD31EF1EC2964B3DF`。与历史优化基线的体积差异来自后续业务与边界测试代码变化，未改变 R8/资源收缩配置。
