...
生产源码基线 `94fd314` 的静态回归构建同样通过 `assembleRelease`：APK 为 32,062,557 B（30.58 MiB），SHA-256 为
`24A55D5C8D35C3D19803A34B33CB2858CD3A5C5494D115F845466B6A1C9CA535`。与历史优化基线的体积差异来自后续业务与边界测试代码变化，未改变 R8/资源收缩配置。
