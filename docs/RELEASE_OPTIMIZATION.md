...
生产源码基线 `44b650d` 的静态回归构建同样通过 `assembleRelease`：APK 为 32,062,557 B（30.58 MiB），SHA-256 为
`A51246BB30CA92A3817A102CF2264557045486C3985BF4ED15551D83DEC15DF2`。与历史优化基线的体积差异来自后续业务与边界测试代码变化，未改变 R8/资源收缩配置。
