...
| JVM 单元测试 Kotlin | 75 | 6,671 | 298 个测试用例 |
...
- 应用启动与壳层、五个一级页面、页面顶部栏、趋势空态、更新反馈、认证与账号安全反馈、设置行、APRS、BLE 配网、存储页、工具子页、弹窗、Bottom Sheet 和首批页面反馈已有 40 张可重复生成的浅色/深色参考图，覆盖窄屏、常规手机、横屏、长中文、设备与群组筛选空态、中继查询无结果以及 1.3/1.5/2.0 倍字体。
