...
当前 46 张参考图在 Windows 本地通过 JVM/Layoutlib 渲染，不依赖模拟器、真机或远程服务。
...
| 认证与账号安全 | 360 x 560 dp | 360 x 300 / 360 x 520 / 320 x 420 dp | 1.3 倍字体注册成功/一次性密码、1.5 倍字体错误/忙碌态，以及 2.0 倍字体密码重置成功反馈 |
