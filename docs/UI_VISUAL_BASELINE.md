...
当前 40 张参考图在 Windows 本地通过 JVM/Layoutlib 渲染，不依赖模拟器、真机或远程服务。
...
| 工具 | 800 x 360 / 360 x 640 / 360 x 800 dp | 360 x 700 / 411 x 891 dp | 横屏、账号审核、工具子页加载态，以及 1.5 倍字体错误、空态和中继查询无结果反馈 |
